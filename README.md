...
* **Professional Home Lab:** I operate a **20-node Cisco Modeling Labs (CML)** environment to master enterprise-scale troubleshooting and network administration.
* **Documentation & GIT:** Using GIT to track my technical progress and ensure all lab configurations and automation scripts are documented and auditable.

## 🚀 Professional Value & Stability
* **NHS Foundation:** Proven discipline and reliability from a background in high-pressure public service.
* **Long-Term Stability:** Fully committed to growing within a dedicated IT team and becoming a permanent cornerstone of the department.
* **Solution-Oriented:** Focused on delivering rapid, high-quality resolutions with a professional and helpful approach to every user request.
* **Infrastructure Ready:** I invest my own time into my lab environment to ensure I am prepared for complex troubleshooting and enterprise-scale challenges.
